var __iPlayerEnemy = 0;

function Player(team, geometry, material, isEnemy)
{
	if(isEnemy)
	{
	    ...
	    var animations = ['stand', 'flip', 'run', 'salutealt', 'wavealt', 'cwalk'];
	    
	    var animation = animations[__iPlayerEnemy];
	    __iPlayerEnemy++;
	    if (__iPlayerEnemy >= animations.length)
	    	__iPlayerEnemy = 0;
	    
	    this.playAnimation(animation, 10);
	...
	// Public properties
	this.team = team;
	this.canJump = isEnemy ? false : true;
	this.fly = isEnemy ? false : true;
	this.cameraHeight = 40;
	this.jumpHeight = isEnemy ? 5 : 125;
	this.maxHealth = 100;
...
Player.prototype = Object.create(THREE.MorphAnimMesh.prototype);
...
Player.prototype.clone = function(object)
{
	...
	THREE.MorphAnimMesh.prototype.clone.call(this, object);
